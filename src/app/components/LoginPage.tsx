...
const content: Record<Language, { title: string; subtitle: string; desc: string; login: string; features: string[] }> = {
  he: {
    title: 'לוח אירועים',
    subtitle: 'עמותת ״בני ברוך-קבלה לעם״',
    desc: 'גישה לכל האירועים, השיעורים וההתכנסויות של עמותת "בני ברוך-קבלה לעם" במקום אחד.',
    login: 'כניסה לאתר',
    features: ['לוח שבועי ויומי', 'אירועים מיוחדים וכנסים', 'קישורים לשיעורים', 'הודעות ועדכונים'],
  },
  en: {
    title: 'Events Calendar',
    subtitle: 'Bnei Baruch-Kabbalah L\'Am Association',
    desc: 'Access all events, lessons and gatherings of the Bnei Baruch-Kabbalah L\'Am Association in one place.',
    login: 'Log in',
    features: ['Weekly & daily schedule', 'Special events & conventions', 'Links to lessons', 'News & updates'],
  },
  ru: {
    title: 'Календарь событий',
    subtitle: 'Организация «Бней Барух – Каббала Ла-Ам»',
    desc: 'Доступ ко всем событиям, урокам и собраниям организации «Бней Барух – Каббала Ла-Ам» в одном месте.',
    login: 'Войти',
    features: ['Недельное и дневное расписание', 'Особые события и конвенции', 'Ссылки на уроки', 'Новости и обновления'],
  },
  es: {
    title: 'Calendario de Eventos',
    subtitle: 'Asociación Bnei Baruch-Cabalá La\'Am',
    desc: 'Accede a todos los eventos, lecciones y encuentros de la Asociación Bnei Baruch-Cabalá La\'Am en un solo lugar.',
    login: 'Entrar',
    features: ['Horario semanal y diario', 'Eventos especiales y convenciones', 'Enlaces a lecciones', 'Noticias y actualizaciones'],
  },
  de: {
    title: 'Veranstaltungskalender',
    subtitle: 'Bnei Baruch-Kabbala L\'Am Verein',
    desc: 'Zugang zu allen Veranstaltungen, Lektionen und Zusammenkünften des Bnei Baruch-Kabbala L\'Am Vereins an einem Ort.',
    login: 'Einloggen',
    features: ['Wochen- und Tagesplan', 'Sonderveranstaltungen & Konventionen', 'Links zu Lektionen', 'Neuigkeiten & Updates'],
  },
  it: {
    title: 'Calendario degli eventi',
    subtitle: 'Associazione Bnei Baruch-Kabbalah L\'Am',
    desc: 'Accedi a tutti gli eventi, lezioni e incontri dell\'Associazione Bnei Baruch-Kabbalah L\'Am in un unico posto.',
    login: 'Accedi',
    features: ['Programma settimanale e giornaliero', 'Eventi speciali e convegni', 'Link alle lezioni', 'Notizie e aggiornamenti'],
  },
  fr: {
    title: 'Calendrier des événements',
    subtitle: 'Association Bnei Baruch-Kabbale L\'Am',
    desc: 'Accédez à tous les événements, cours et rassemblements de l\'Association Bnei Baruch-Kabbale L\'Am en un seul endroit.',
    login: 'Se connecter',
    features: ['Programme hebdomadaire et quotidien', 'Événements spéciaux et conventions', 'Liens vers les cours', 'Actualités et mises à jour'],
  },
  pt: {
    title: 'Calendário de Eventos',
    subtitle: 'Associação Bnei Baruch-Cabala La\'Am',
    desc: 'Acesse todos os eventos, aulas e encontros da Associação Bnei Baruch-Cabala La\'Am em um só lugar.',
    login: 'Entrar',
    features: ['Agenda semanal e diária', 'Eventos especiais e convenções', 'Links para aulas', 'Notícias e atualizações'],
  },
  uk: {
    title: 'Календар подій',
    subtitle: 'Організація «Бней Барух – Кабала Ла-Ам»',
    desc: 'Доступ до всіх подій, уроків і зборів організації «Бней Барух – Кабала Ла-Ам» в одному місці.',
    login: 'Увійти',
    features: ['Щотижневий і щоденний розклад', 'Особливі події та конвенції', 'Посилання на уроки', 'Новини та оновлення'],
  },
  tr: {
    title: 'Etkinlik Takvimi',
    subtitle: 'Bnei Baruch-Kabala L\'Am Derneği',
    desc: 'Bnei Baruch-Kabala L\'Am Derneği\'nin tüm etkinliklerine, derslerine ve toplantılarına tek bir yerden erişin.',
    login: 'Giriş yap',
    features: ['Haftalık ve günlük program', 'Özel etkinlikler ve konvansiyonlar', 'Derslere bağlantılar', 'Haberler ve güncellemeler'],
  },
  bg: {
    title: 'Календар на събитията',
    subtitle: 'Сдружение „Бней Барух – Кабала Ла-Ам"',
    desc: 'Достъп до всички събития, уроци и събирания на Сдружение „Бней Барух – Кабала Ла-Ам" на едно място.',
    login: 'Вход',
    features: ['Седмично и дневно разписание', 'Специални събития и конвенции', 'Връзки към уроци', 'Новини и актуализации'],
  },
};
