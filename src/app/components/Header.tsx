        ...
        <div className={`flex items-center justify-between relative ${isRTL ? 'flex-row-reverse' : ''}`}>
          ...
          >
            <div className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
              {/* SVG Logo */}
              <div className="w-9 h-9 bg-white rounded-full p-1.5 flex items-center justify-center shadow-sm transition-transform duration-300 group-hover:scale-105">
              ...
              <div className={`${isRTL ? 'text-right' : 'text-left'}`}>
                <div className="text-blue-900 text-2xl font-bold leading-tight transition-colors duration-300 group-hover:text-blue-700">
                  {currentLogoText.mainText}
                </div>
                <div className="text-blue-800/80 text-sm leading-tight">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <Link to="/">
              <h1 className="text-2xl font-bold text-blue-900 transition-all duration-300 hover:text-blue-700 whitespace-nowrap">
                {t.appName}
              </h1>
            </Link>
          </div>
